var book1 = { 
    ...
    "pictureUrl": "https://www.amazon.com/Illusive-Friends-Adversaries-Book-ebook/dp/B07JJC7HXH/ref=sr_1_2?ie=UTF8&qid=1543974407&sr=8-2&keywords=celeste-marie+lyon", 
    "price": 25, 
    "sellingPoints": [
...
var book5 = {
    ...
    "price": 3,
    "sellingPoints": [`
        "With every page the situation gets crazier, zanier, more improbable, also funnier...Kirkwood's bizarre humor comes off, thanks to his ability to throw opposites together, with a stand up comic's timing."
                - Publishers Weekly

        "An extraordinary novel...an ingenious, intriguing, and also moving story about two losers who become friends. It is also a revealing book about burning your bridges behind you."
                - Sacramento Union

        "This novel is woven together with such artistic acumen that suspense never ebbs. The plot structure, characterization, dialog and style are virtually flawless." 
                - Chicago Sun-Times`]
}